...
import coil.load
import com.example.platzi_api.databinding.ItemProductBinding
import com.example.platzi_api.models.product.ResponseProductItem

class ProductPagingAdapter(private val listener: ProductPagingAdapter.Listener) :
    PagingDataAdapter<ResponseProductItem, ProductPagingAdapter.ProductViewHolder>(COMPARATOR) {
